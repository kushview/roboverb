...
public:
    ...
    void handleMenuResult (int result)
    {
        switch (result)
        {
            ...
            case 2:  pluginHolder->askUserToSaveState("roboverb"); break;
#if ! KV_PLUGINS_DEMO
            case 3:  pluginHolder->askUserToLoadState("roboverb"); break;
#else
            case 3: {
                AlertWindow::showMessageBoxAsync(AlertWindow::InfoIcon, "Roboverb Demo", "Loading Roboverb state is available in the full version");
            }
#endif
...
//==============================================================================
class RoboverbApplication  : public JUCEApplication
{
public:
    //==============================================================================
    RoboverbApplication() {}
    ...
    */
    class MainWindow    : public StandaloneFilterWindow
    {
    public:
        MainWindow (String name)  : StandaloneFilterWindow (name,
                                                    Colours::lightgrey,
                                                    new PropertySet(), true)
        {
            setVisible (true);
        }
...
START_JUCE_APPLICATION (RoboverbApplication)
