...
ifeq ($(NDK_DEBUG),1)
  ...
  LOCAL_CPPFLAGS += -fsigned-char -fexceptions -frtti -I "../../JuceLibraryCode" -I "../../../element/modules" -I "../../../libjuce/src/modules" -O3 -std=c++11 -std=gnu++11 -D "JUCE_ANDROID=1" -D "JUCE_ANDROID_API_VERSION=10" -D "JUCE_ANDROID_ACTIVITY_CLASSNAME=com_yourcompany_standalone_Standalone" -D JUCE_ANDROID_ACTIVITY_CLASSPATH=\"com/yourcompany/standalone/Standalone\" -D "NDEBUG=1" -D "JUCER_ANDROID_7F0E4A25=1" -D "JUCE_APP_VERSION=1.0.4" -D "JUCE_APP_VERSION_HEX=0x10004"
  LOCAL_LDLIBS := -llog -lGLESv2
