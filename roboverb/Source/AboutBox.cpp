...
AboutBox::AboutBox ()
{
    ...
    addAndMakeVisible (pluginLabel = new Label ("pluginLabel",
                                                TRANS("Roboverb")));
    pluginLabel->setFont (Font (24.00f, Font::plain));
...
<JUCER_COMPONENT documentType="Component" className="AboutBox" template="../Templates/Component.cpp"
                 componentName="" parentClasses="public Component" constructorParams=""
                 variableInitialisers="" snapPixels="8" snapActive="1" snapShown="1"
                 overlayOpacity="0.330" fixedSize="1" initialWidth="300" initialHeight="176">
