...
PluginView::PluginView ()
{
    ...
    comb4->setButtonText (String::empty);
    ...
    addAndMakeVisible (roomSizeLabel = new Label ("roomSizeLabel",
                                                  TRANS("Room Size")));
    roomSizeLabel->setFont (Font (12.00f, Font::plain));
    ...
    addAndMakeVisible (dampingLabel = new Label ("dampingLabel",
                                                 TRANS("Damping")));
    dampingLabel->setFont (Font (12.00f, Font::plain));
    ...
    addAndMakeVisible (wetLabel = new Label ("wetLabel",
                                             TRANS("Wet")));
    wetLabel->setFont (Font (12.00f, Font::plain));
    ...
    addAndMakeVisible (dryLabel = new Label ("dryLabel",
                                             TRANS("Dry")));
    dryLabel->setFont (Font (12.00f, Font::plain));
    ...
    widthLabel->setFont (Font (12.00f, Font::plain));
    ...
    addAndMakeVisible (damping = new Element::SkinDial ("damping"));
    ...
    addAndMakeVisible (roomSize = new Element::SkinDial ("roomSize"));
    ...
    addAndMakeVisible (wetLevel = new Element::SkinDial ("wetLevel"));
    ...
    addAndMakeVisible (dryLevel = new Element::SkinDial ("dryLevel"));
    ...
    helpButton->setColour (TextButton::textColourOnId, Colour (0xe7e5e5e5));
    helpButton->setColour (TextButton::textColourOffId, Colour (0xdee5e5e5));
    ...
    {
        if (Element::SkinDial* sd = dynamic_cast<Element::SkinDial*> (
            getChildComponent(i)))
        {
            sd->setScale (2);
...
void PluginView::paint (Graphics& g)
{
    ...
    g.setGradientFill (ColourGradient (Colour (0xa35c0000),
                                       56.0f, static_cast<float> (-56),
                                       Colour (0xaa401818),
                                       424.0f, 224.0f,
                                       true));
...
<JUCER_COMPONENT documentType="Component" className="PluginView" template="../Templates/Component.cpp"
                 componentName="" parentClasses="public Component, private ValueTree::Listener"
  ...
  <TOGGLEBUTTON name="allpass4" id="6573319772fb73a6" memberName="allpass4" virtualName="ToggleSwitch"
                ...
                needsCallback="1" radioGroupId="0" state="0"/>
  <SLIDER name="width" id="eb11bcc99f28a586" memberName="width" virtualName="Element::SkinDial"
          explicitFocusOrder="0" pos="131 111 56 56" min="0" max="1" int="0"
          style="RotaryVerticalDrag" textBoxPos="NoTextBox" textBoxEditable="1"
          textBoxWidth="80" textBoxHeight="20" skewFactor="1"/>
  <SLIDER name="damping" id="36e7b175ad3e7b34" memberName="damping" virtualName="Element::SkinDial"
          explicitFocusOrder="0" pos="72 111 56 56" min="0" max="1" int="0"
          style="RotaryVerticalDrag" textBoxPos="NoTextBox" textBoxEditable="1"
          textBoxWidth="80" textBoxHeight="20" skewFactor="1"/>
  <SLIDER name="roomSize" id="4818250426324d72" memberName="roomSize" virtualName="Element::SkinDial"
          explicitFocusOrder="0" pos="13 111 56 56" min="0" max="1" int="0"
          style="RotaryVerticalDrag" textBoxPos="NoTextBox" textBoxEditable="1"
          textBoxWidth="80" textBoxHeight="20" skewFactor="1"/>
  <SLIDER name="wetLevel" id="60f92ab9097a3a68" memberName="wetLevel" virtualName="Element::SkinDial"
          explicitFocusOrder="0" pos="14 46 56 56" min="0" max="1" int="0"
          style="RotaryVerticalDrag" textBoxPos="NoTextBox" textBoxEditable="1"
          textBoxWidth="80" textBoxHeight="20" skewFactor="1"/>
  <SLIDER name="dryLevel" id="71c4babfc54096a3" memberName="dryLevel" virtualName="Element::SkinDial"
